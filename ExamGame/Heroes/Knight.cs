...
{
    /*
     * Class "Knight", extending class "Hero" and containing the following constants:
    ...
    public class Knight : Hero
    {
        ...
        private const int MULTIPLY_DAMAGE_CHANCE = 10;
        private const int MULTIPLY_DAMAGE_PERCENT = 200;
        private const int BLOCK_ATTACK_CHANCE = 20;

        public Knight(string nickname) : base(nickname, ATTACK_POINTS, ARMOUR_POINTS)
        {
        }
